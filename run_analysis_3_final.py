...
output = {
    ...
    "mechanism": "Possible: (1) Information arrival continues over time, (2) Participant learning improves pricing, (3) Selection bias: harder-to-predict events stay open longer",
    "confound": "This analysis documents correlation between market age and calibration; causation remains unclear. Requires within-market panel data.",
